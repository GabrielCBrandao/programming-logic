programa
{
	...
	inteiro xcomida_cobra= 300
	inteiro ycomida_cobra= 300
	...
	funcao desenhar_painel(){
		...
		funcao logico cobra_comeu_comida(){
			se(xcabeca_cobra==xcomida_cobra e ycabeca_cobra==ycomida_cobra ){
				retorne verdadeiro
			...
			funcao sortear_posicao_comida(){
				...
				se(cobra_comeu_comida()){
					xcomida_cobra= xposicoes_comida[xindice]
					ycomida_cobra= yposicoes_comida [yindice]
					
				}
			}
			funcao desenhar_comida(){
				g.definir_cor(g.COR_VERMELHO)
				g.desenhar_retangulo(xcomida_cobra, ycomida_cobra,25, 25, falso, verdadeiro)
		}
